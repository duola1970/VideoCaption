...
class BiModalEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model_M1, d_model_M2, d_model, dout_p, H, d_ff_M1, d_ff_M2):
        ...
        # 自注意力层
        self.self_att_M1 = MultiheadedAttention(d_model_M1, d_model_M1, d_model_M1, H, dout_p, d_model)      # (128,128,128,4)
        self.self_att_M2 = MultiheadedAttention(d_model_M2, d_model_M2, d_model_M2, H, dout_p, d_model)      # (1024,1024,1024,4)
        # 双模态注意力层
        self.bi_modal_att_M1 = MultiheadedAttention(d_model_M1, d_model_M2, d_model_M2, H, dout_p, d_model)  # (128,1024,1024,4)
        self.bi_modal_att_M2 = MultiheadedAttention(d_model_M2, d_model_M1, d_model_M1, H, dout_p, d_model)  # (1024,128,128,4)
        # 位置全连接网络层
    ...
    def forward(self, x, masks):
        ...
        '''
        M1, M2 = x
        M1_mask, M2_mask = masks  # mask_A,mask_V  (B,1,Sm)
